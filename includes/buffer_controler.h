...
/*   Updated: 2017/09/14 14:24:55 by mo0ky            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int					fill_buffer_static(t_buffer_static *controler, void *input, size_t size);
int					filln_buffer_static(t_buffer_static *ctrl, void *c, size_t n);
int					fill_buffer_malloc(t_buffer_malloc *controler, char *input, size_t size);
